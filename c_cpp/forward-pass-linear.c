// Below code contains a forward pass implementation of a simple CNN model
// It uses multidimensional arrays to represent the input, filters, and output
// Goal: Convert multidimensional arrays to 1D arrays for better memory management
